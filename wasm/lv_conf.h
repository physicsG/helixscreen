 ...
 * - LV_OS_MQX
 * - LV_OS_CUSTOM */
#define LV_USE_OS   LV_OS_NONE  /* WASM: single-threaded */
...
/*Use SDL to open window on PC and handle mouse and keyboard*/
    ...
    #define LV_SDL_MOUSEWHEEL_MODE  LV_SDL_MOUSEWHEEL_MODE_ENCODER  /* WASM: CROWN block has an upstream bug */  /*LV_SDL_MOUSEWHEEL_MODE_ENCODER/CROWN*/
#endif
